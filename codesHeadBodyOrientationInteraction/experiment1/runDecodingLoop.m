clear all;
testName = 'A1-FC';
outFolder = ('C:\Users\u0137276\Desktop\epDATA\expVP\decodingMatlab\A1\binned\decoding\FC\');
...
%%     
    ...
    hold all
    set(gca, 'FontSize', 12, 'FontWeight','bold', 'yLim', [0, 1], 'yTick', [0:0.1:1], 'xLim', [0, 8], 'xTick', [1: 7], 'xticklabel', {xValues{:}});
