clear all;
bs1=load('a1bc_stats.mat'); bs1=bs1.raw;
fs1=load('a1fc_stats.mat'); fs1=fs1.raw;
b1=load('a1bc.mat'); b1=b1.a1bc;
f1=load('a1fc.mat'); f1=f1.a1fc;
%
bs2=load('a2bc_stats.mat'); bs2=bs2.raw;
fs2=load('a2fc_stats.mat'); fs2=fs2.raw;
b2=load('a2bc.mat'); b2=b2.a2bc;
f2=load('a2fc.mat'); f2=f2.a2fc;
%
n1=load('corrR_an1.mat'); n1=n1.corrR;
o1=load('corrR_ao1.mat'); o1=o1.corrR;
n2=load('corrR_an2.mat'); n2=n2.corrR;
o2=load('corrR_ao2.mat'); o2=o2.corrR;
%%
...
%%
% save('corrAll_A.mat', 'allCorr');
% save('corrInt_A.mat', 'intCorr');
% save('corrComInt_A.mat', 'comIntCorr');
