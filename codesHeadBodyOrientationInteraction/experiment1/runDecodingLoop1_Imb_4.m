clear all;
testName = 'A1-BC2FC1';
outFolder = ('C:\Users\u0137276\Desktop\epDATA\expVP\decodingMatlab\A1\decoding2x2\BC2FC\');
...
%         pt1 = tr1(randperm(length(tr1))); pt2 = tr2(randperm(length(tr2)));
        for t = 1:8
            ...
            for a = 1:length(cellRowsA)
                ...
                testLblA = testLblA(t2); testLblB = testLblB(t2);
                trainLblA = trainLblA(contains(trainLblA, 'vp1')|contains(trainLblA, 'vp3')|contains(trainLblA, 'vp5')|...
                    contains(trainLblA, 'vp7'));
                trainLblB = trainLblB(contains(trainLblB, 'vp1')|contains(trainLblB, 'vp3')|contains(trainLblB, 'vp5')|...
                    contains(trainLblB, 'vp7'));
